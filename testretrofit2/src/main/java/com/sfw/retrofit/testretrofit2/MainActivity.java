package com.sfw.retrofit.testretrofit2;
                ...
                public void run() {
                    ...
                    call.enqueue(new Callback<WeatherBean>() {
                        ...
                        public void onResponse(Call<WeatherBean> call, Response<WeatherBean> response) {
                            ...
                            Log.d("cylog",weatherBean.getResults().get(0).getNow().getTemperature()+"");
                            System.out.println(weatherBean.getResults().get(0).getNow().getTemperature()+"");
